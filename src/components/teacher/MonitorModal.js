// src/components/teacher/MonitorModal.js - UPDATED TO PASS MONITOR CONTEXT
import React from 'react';
import { useMonitorData } from './hooks/useMonitorData';
import { useMonitorState } from './hooks/useMonitorState';
import { getContextConfig } from './utils/monitorHelpers';
import StudentsView from './components/StudentView'; // ✅ FIXED: Import name
                        ...
                        <div className="p-3" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
                            {activeView === 'students' && (
                                <StudentsView 
                                    ...
                                    monitorContext={monitorContext}  // ✅ NEW: Pass monitor context
                                />
                            )}
                            ...
                            <div className="d-flex justify-content-between align-items-center w-100">
                                <div className="d-flex align-items-center">
                                    ...
                                    <small className="text-muted">
                                        ...
                                        {/* ✅ NEW: Show context info */}
                                        {monitorContext === 'subject' && (
                                            <span className="text-info"> • Subject Teacher View</span>
                                        )}
                                        {monitorContext === 'homeroom' && (
                                            <span className="text-warning"> • Homeroom Teacher View</span>
                                        )}
                                    </small>
                                </div>
